...
@NgModule({
  imports:      [ BrowserModule, FormsModule, MaterialModule.forRoot(), MdDialogModule.forRoot() ],
  declarations: [ AppComponent, DailyTasksListComponent, DailyTasksItemComponent, DailyTasksDialogComponent ],
